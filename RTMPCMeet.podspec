...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "zzuzjq"
  # s.authors            = { "zzuzjq" => "984630262@qq.com" }
  # s.social_media_url   = "http://twitter.com/zzuzjq"
  ...
  s.source       = { :git => "https://github.com/BoYuanZjq/RTMPCMeet.git", :tag => "#{s.version}",:submodules => true }
